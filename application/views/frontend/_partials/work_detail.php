...
<html lang="en" class="no-js">
  ...
  <body>
    ...
    <a href="index.html#work-section" class="back-to-all">Back to all cases</a>
    <div class="case-header">
      <div class="media-wrapper">
        <video muted autoplay loop src="<?php echo base_url('assets/frontend/images/@stock/case-study.mp4')?>"></video>
      </div>
        <div class="case-title">
          <div class="row">
              <div class="large-8 columns">
                <h2>Spread the love. </h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem asperiores ipsa delectus deserunt consequuntur.</p>
              </div>
          </div>
        </div>
    ...
    <div class="case-study-content">
        ...
        <div class="full light-grey">
            ...
            <div class="large-6 columns">
              <img src="<?php echo base_url('assets/frontend/images/@stock/iphones.png')?>" alt="">
            </div>
        </div>
        <div class="full">
        ...
        <div class="full colored-bg red">
          <p class="centered-text">
            <img src="<?php echo base_url('assets/frontend/images/@stock/result-1.png')?>" alt="">
          </p>
        </div>
        <div class="full">
        ...
        <div class="full colored-bg purple">
          <p class="centered-text">
            <img src="<?php echo base_url('assets/frontend/images/@stock/result-2.png')?>" alt="">
          </p>
        </div>

        <div class="full case-video-wrapper">
<!--             <div class="case-image-placeholder">
              <img src="images/@stock/case-study.jpg" alt="">
            </div> -->
            <video loop muted playsinline autoplay preload>
              <source src="<?php echo base_url('assets/frontend/images/@stock/case-study.mp4')?>" type='video/mp4'>
            </video>
        </div>
        <div class="full colored-bg orange">
          <p class="centered-text">
            <img src="<?php echo base_url('assets/frontend/images/@stock/result-3.png')?>" alt="">
          </p>
        </div>
        <div class="full">
        ...
        <div class="full light-grey">
            <p class="centered-text">
              <img src="<?php echo base_url('assets/frontend/images/@stock/result-4.jpg')?>" alt="">
            </p>
        </div>
        <div class="case-nav">
          <div class="large-6 columns">
