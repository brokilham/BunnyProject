      ...
      <div class="content invisible">
            ...
            <div class="clients">
                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client client-bg">
                    <img alt="" src="<?php echo base_url('assets/frontend/images/@stock/client-1.png')?>" />
                  </div>
                </div>
                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client">
                    <img alt="" src="<?php echo base_url('assets/frontend/images/@stock/client-2.png')?>" />
                  </div>
                </div>
                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client">
                    <img alt="" src="<?php echo base_url('assets/frontend/images/@stock/client-3.png')?> />
                  </div>
                </div>
                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client">
                    <img alt="" src="<?php echo base_url('assets/frontend/images/@stock/client-4.png')?>" />
                  </div>
                </div>

                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client">
                    <img alt="" src="<?php echo base_url('assets/frontend/images/@stock/client-5.png')?>" />
                  </div>
                </div>
                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client">
                    <img alt="" src="<?php echo base_url('assets/frontend/images/@stock/client-6.png')?>" />
                  </div>
                </div>
                <div class='large-2 medium-3 small-4 columns'>
                  <div class="client">
        ...
        <div class="full">
          ...
          <div class="large-6 medium-6 columns">
            <p class="big-text">We use research and strategy to create brands’ most powerful values. We achieve this via our four steps of see, think, create and practice. </p>
          ...
          <div class="large-6 medium-6 columns">
            <p class="big-text">Our journey started in 2005 and we have 18 people form the globe, we are on the goals of our clients, and it makes the work a lot of fun.</p>
            <p class="big-text">If you are curious about the brands we can provide to you, we can offer a range of talks.</p>
          </div>
            ...
            <div class='mod modBoxedTextSlider'>
              <div class='boxes'>
                <div class='slidebox' style=''>
                  <img src="<?php echo base_url('assets/frontend/images/@stock/member-1.png')?>" alt="">
                  <p class="big-letter">
                    S
                  </p>
                ...
                <div class='slidebox' style=''>
                  <img src="<?php echo base_url('assets/frontend/images/@stock/member-2.png')?>" alt="">
                  <p class="big-letter">
                    Z
                  </p>
                  <div class="member-dec">
                ...
                <div class='slidebox' style=''>
                  <img src="<?php echo base_url('assets/frontend/images/@stock/member-3.png')?>" alt="">
                  <p class="big-letter">
                    J
                  </p>
                  <div class="member-dec">
                ...
                <div class='slidebox' style=''>
                  <img src="<?php echo base_url('assets/frontend/images/@stock/member-4.png')?>" alt="">
                  <p class="big-letter">
                    C
                  </p>
                  <div class="member-dec">
                ...
                <div class='slidebox' style=''>
                  <img src="<?php echo base_url('assets/frontend/images/@stock/member-5.png')?>" alt="">
                  <p class="big-letter">
                    T
                  </p>
                  <div class="member-dec">
        ...
        <div class="full footer-bg">
          ...
          <div class="large-6 columns">
            ...
            <p class="big-text">No matter if you are a super big agency, a fresh start-up, a very small studio or just someone with an idea or an unfinished idea about a project. You should send us an email.</p>
            <div class="two spacing"></div>
            <p class="contact-email">
              <em>Contact us at</em>
        ...
        <div class="works">
          ...
          <div class="large-3 medium-6 columns">
            <div class="item">
              <a href="case-study-2.html">
                <div class="circle-wrap">
                  <img src="<?php echo base_url('assets/frontend/images/@stock/work-8.jpg')?>" alt="">
                </div>
                <div class="client-name">
                  <h2>Client</h2>
                  <h3>Twitter</h3>
